...
def verify_password(password, stored):
    ...
    if not stored:
        return False
    if '$' not in stored:
        # পুরনো plain text password (backward compatible)
...
# ============================================
# 🔐 অ্যাডমিন পাসওয়ার্ড পরিবর্তনের API (নতুন)
# ============================================
